...
const char RESULT[] = 
	"<html>"
		"<head>"
			"<title>News List</title>"
			"<style type=\"text/css\">a {font-family: Verdana, Arial, Helvetica, sans-serif;color: black; font-size: 8pt; font-weight: bold;}span {font-family: Verdana, Arial, Helvetica, sans-serif;color: black; font-size: 10pt; font-weight: normal;}span.date {font-family: Verdana, Arial, Helvetica, sans-serif;color: #D00000; font-size: 10pt; font-weight: normal;}</style>"
		"</head>"
		"<body>"
			"<title>FastSort.cpp</title>"
				"int n, a[n]; //n - количество элементов\n"
